  ...
  return (
    <ArgonBox width="100%">
      <ArgonBox display="flex" alignItems="center" mb={2}>
        <ArgonBox bgColor={icon.color} width="1.25rem" height="1.25rem" borderRadius="sm" color="white" fontSize={size.xs} display="flex" justifyContent="center" alignItems="center"
          shadow="md" mr={1} variant="gradient">
          <Icon>{icon.component}</Icon>
        </ArgonBox>
        <ArgonTypography variant="caption" textTransform="capitalize" fontWeight="medium" color="text">
          {label}
        </ArgonTypography>
      </ArgonBox>
